...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        ...
        <div id="bo_v_info">
            <h2>페이지 정보</h2>
            <span class="sound_only">금액</span><?php echo number_format($view['wr_2']) ?>원
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_con">
            ...
            <div class="text-center">
                <a href="<?php echo $view['wr_link1']?>" target="_blank" rel="noopener noreferrer" class="product-link">자세히 보러가기</a>
            </div>
        </div>
    ...
    <ul class="bo_v_nb">
        <?php echo latest('theme/product', 'product', 12, 25); ?>
