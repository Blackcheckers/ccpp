...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <div class="write_div">
            ...
            <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input half_input datepicker" size="50" placeholder="시작일">
            <label for="wr_2" class="sound_only">종료일</label>
            <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" class="frm_input half_input datepicker" size="50" placeholder="종료일">
        </div>
